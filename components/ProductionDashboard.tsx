...
function Teacher({user,state}:{user:any;state:any}){
 ...
 return <div className="page"><PageHead eyebrow="My teaching" title={`Hello, ${user.name}`} text="Your required evaluations, preparation, feedback and development actions." actions={<div className="button-row"><AppLink className="button secondary" href="/actions">My actions</AppLink><AppLink className="button primary" href="/lesson-planning">Create lesson plan</AppLink></div>}/>
...
function Manager({user,state}:{user:any;state:any}){
 ...
 return <div className="page"><PageHead eyebrow="Department leadership" title={user.department} text="Required observations and next actions for staff in your reporting hierarchy." actions={<div className="button-row"><AppLink className="button secondary" href="/actions">Action centre</AppLink><AppLink className="button primary" href="/evaluations">Schedule / manage observations</AppLink></div>}/>
...
function Leadership({user,state,division=false}:{user:any;state:any;division?:boolean}){
 ...
 return <div className="page"><PageHead eyebrow={division?user.division:"Whole school · Master"} title="Teacher Evaluation" text="Live progress against the school’s published evaluation requirements." actions={<div className="button-row"><AppLink className="button secondary" href="/actions">Action centre</AppLink>{!division&&<AppLink className="button primary" href="/master">Configure system</AppLink>}</div>}/>
