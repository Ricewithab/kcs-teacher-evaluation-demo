...
const initial:Phase[]=[
 {id:1,name:"Starter / retrieval",minutes:8,teacher:"Display three coordinate pairs and ask students to compare changes in x and y.",students:"Complete retrieval questions individually, then compare with a partner.",assessment:"Mini-whiteboards"},
 {id:2,name:"Explicit instruction",minutes:15,teacher:"Model gradient as change in y ÷ change in x and connect visual steepness to the calculation.",students:"Annotate a worked example and explain what each part of the calculation represents.",assessment:"Targeted questioning"},
 {id:3,name:"Guided practice",minutes:17,teacher:"Work through positive, negative and zero-gradient examples; surface common sign errors.",students:"Calculate gradients and justify answers using coordinates from the graph.",assessment:"Hinge question"},
 {id:4,name:"Independent practice",minutes:22,teacher:"Circulate, prompt and provide scaffold/extension tasks.",students:"Solve differentiated gradient and straight-line problems.",assessment:"Live checking"},
...
function Preview({label,value}:{label:string;value:string}){return <div className="preview-row"><span>{label}</span><strong>{value}</strong></div>}
